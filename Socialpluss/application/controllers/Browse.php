...
class Browse extends CI_Controller {
	...
	function search($search_key = '')
	{
		...
		$page_data['page_title']	=	'Resultado da pesquisa';
	...
	function mylist()
	{
		...
		$page_data['page_title']	=	'Meus Likes';
		$this->load->view('frontend/index', $page_data);
	}
	...
	function playmovie($movie_id = '')
	{
		...
		$page_data['page_title']	=	'Assistir Filme';
	...
	function playseries($series_id = '', $season_id = '')
	{
		...
		$page_data['page_title']	=	'Assistir Séries';
		$page_data['series_id']		=	$series_id;
		$this->load->view('frontend/index', $page_data);
	}
	...
	function youraccount()
	{
		...
		$page_data['page_title']	=	'Sua Conta';
		$this->load->view('frontend/index', $page_data);
	}
	...
	function switchprofile()
	{
		...
		$page_data['page_title']		=	'Escolher Perfil';
	...
	function emailchange()
	{
		...
		$page_data['page_title']		=	'Editar Email';
		$this->load->view('frontend/index', $page_data);
	...
	function passwordchange()
	{
		...
		$page_data['page_title']		=	'Editar Senha';
		$this->load->view('frontend/index', $page_data);
	...
	function cancelplan()
	{
		...
		$page_data['page_title']		=	'Cancelar Plano';
		$this->load->view('frontend/index', $page_data);
	...
	function purchaseplan()
	{
		...
		$page_data['page_title']		=	'Carregar pLanos';
		$this->load->view('frontend/index', $page_data);
	...
	function purchasestripe()
	{
		...
		$page_data['page_title']		=	'Carregar Pacotes';
	...
	function billinghistory()
	{
		...
		$page_data['page_title']	=	'Histórico';
		$this->load->view('frontend/index', $page_data);
	}
