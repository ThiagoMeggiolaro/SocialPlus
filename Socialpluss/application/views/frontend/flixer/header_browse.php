...
<style>
	...
	background:linear-gradient(to right, rgb(28, 152, 237), rgba(27, 0, 255, 0.83));
	}
	.nav_dark {
	background: linear-gradient(to right, rgb(28, 152, 237), rgba(27, 0, 255, 0.83));
	padding: 10px;
	...
	<div class="container" style=" width: 100%;">
		<div class="navbar-header">
			<a href="<?php echo base_url();?>index.php?browse/home" class="navbar-brand">
				<img src="<?php echo base_url();?>/assets/global/logo.png" style=" height:100px;margin:-50px 0px;" />
			</a>
		...
		<div class="navbar-collapse collapse" id="navbar-main">
			<ul class="nav navbar-nav">
				...
				<li class="dropdown">
					<a class="dropdown-toggle" data-toggle="dropdown" href="" style="color: black; font-weight: bold;">
				...
				<li>
					<a href="<?php echo base_url();?>index.php?browse/mylist" style="color: black;">Meus Likes <i class="fa fa-heart"></i></a>
				</li>
			</ul>
			...
			<ul class="nav navbar-nav navbar-right">
				<li class="dropdown">
					...
					<ul class="dropdown-menu" aria-labelledby="themes">
						...
						<?php endif;?>
						<li class="divider"></li>
						<li><a href="<?php echo base_url();?>index.php?browse/manageprofile">Gerenciar Perfil</a></li>
						<li class="divider"></li>
						...
						<?php endif;?>
						<li><a href="<?php echo base_url();?>index.php?browse/youraccount">Conta</a></li>
			...
			<form class="navbar-form navbar-right" method="post" action="<?php echo base_url();?>index.php?browse/search">
				<div class="form-group">
					<input type="text" class="form-control" placeholder="Pesquise filmes e séries" 
						style="background-color: white; border: 1px solid #808080;" name="search_key">
				</div>
				<button type="submit" class="btn btn-default" style="background-color: black;"><i class="fa fa-search" aria-hidden="true"></i></button>
			</form>
		</div>
	</div>
</div>
