		...
		<div class="grid simple ">
			...
			<div class="grid-body no-border">
				...
				<form method="post" action="<?php echo base_url();?>index.php?admin/movie_edit/<?php echo $movie_id;?>" 
					...
					<div class="row">
						<div class="col-md-6 col-sm-12 col-xs-12">
							...
							<div class="form-group">
								...
								<span class="help">- Youtube ou host</span>
								<div class="controls">
							...
							<div class="form-group">
								...
								<span class="help">- Icone do Filme</span>
								<div class="controls">
							...
							<div class="form-group">
								...
								<span class="help">- Banner do Filme</span>
								<div class="controls">
							...
							<div class="form-group">
								...
								<span class="help">- Seleciona os gêneros</span>
								<div class="controls">
					...
					<hr>
					<div class="form-group">
						<input type="submit" class="btn btn-success col-md-3 col-sm-12 col-xs-12" value="Alterar Filme" style="margin:0px 5px 5px 0px;">
