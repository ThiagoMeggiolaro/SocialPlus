	...
	<div class="col-md-6 col-sm-12 col-xs-12">
		<div class="grid simple ">
			...
			<div class="grid-body">
				...
				<a href="<?php echo base_url();?>index.php?admin/series_edit/<?php echo $series_id.'/'.$season_id;?>" class="btn btn-default">Voltar</a>
			</div>
		</div>
	</div>
	<script>
		...
		<div class="grid-body">
			<form method="post" action="<?php echo base_url();?>index.php?admin/episode_create/<?php echo $series_id.'/'.$season_id;?>"
				...
				<div class="form-group">
					...
					<span class="help">- youtube or site</span>
					<div class="controls">
				...
				<div class="form-group">
					...
					<span class="help">- Foto da capa</span>
					<div class="controls">
	...
	<div class="grid simple ">
		...
		<div class="grid-body">
			<form method="post" action="<?php echo base_url();?>index.php?admin/episode_edit/<?php echo $series_id.'/'.$season_id.'/'.$episode_id;?>"
				...
				<div class="form-group">
					<label class="form-label">Video Url</label>
					<span class="help">- youtube ou site</span>
					<div class="controls">
