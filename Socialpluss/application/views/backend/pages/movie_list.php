					...
					<tbody>
						...
						<tr>
							...
							<td style="vertical-align: middle;">
								...
								Editar</a>
								<a href="<?php echo base_url();?>index.php?admin/movie_delete/<?php echo $row['movie_id'];?>" class="btn btn-danger btn-xs btn-mini" onclick="return confirm('Voce quer deletar?')">
								Deletar</a>
							</td>
						</tr>
						<?php endforeach;?>
