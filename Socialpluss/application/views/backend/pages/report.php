		...
		<div class="grid simple ">
			<div class="grid-title" style="text-align: center;">
				...
				<select class="select2" style="width:200px;" id="year">
					<option value="2019" <?php if($year == '2019')echo 'selected';?>>2021</option>
					<option value="2018" <?php if($year == '2018')echo 'selected';?>>2020</option>
					<option value="2017" <?php if($year == '2017')echo 'selected';?>>2019</option>
				</select>
				<button type="button" onClick="submit()" class="btn btn-success btn-cons" style="margin:0px;">Filtros</button>
				<script>
					function submit()
					{
