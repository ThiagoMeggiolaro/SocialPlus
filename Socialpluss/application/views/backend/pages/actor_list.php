					...
					<tbody>
						...
						<tr>
							...
							<td style="vertical-align: middle;">
								...
								Editar</a>
								<a href="<?php echo base_url();?>index.php?admin/actor_delete/<?php echo $row['actor_id'];?>" class="btn btn-danger btn-xs btn-mini" onclick="return confirm('Você quer deletar?')">
								Deletar</a>
							</td>
						</tr>
						<?php endforeach;?>
