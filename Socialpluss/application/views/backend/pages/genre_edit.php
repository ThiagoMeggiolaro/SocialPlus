					...
					<div class="row">
						<div class="col-md-8 col-sm-8 col-xs-8">
							<div class="form-group">
								<label class="form-label">Nome do Genero</label>
								<span class="help">Exemplo: "Ação, Romance"</span>
								<div class="controls">
							...
							<div class="form-group">
								...
								<a href="<?php echo base_url();?>index.php?admin/genre_list" class="btn btn-default">Voltar</a>
							</div>
						</div>
					</div>
				</form>
